                ...
                <div class="panel-body">
                    <form>
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control"
                                                type="text" name="titulo-up" required="" maxlength="30">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control"
                                                type="text" name="autor-up" required="" maxlength="30">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control"
                                                type="text" name="edicion-up" maxlength="30">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[0-9]{1,3}" class="form-control" type="text"
                                                name="ejemplares-up" maxlength="3">
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control"
                                                type="text" name="ubicacion-up" maxlength="30">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">¿El archivo PDF será descargable para los
                                        clientes?</label>
                                    <div class="radio radio-primary">
                                        <label>
                                            <input type="radio" name="optionsPDF" id="optionsRadios1" value="Si"
                                                checked="">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <p class="lead">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi voluptatem quas impedit, sint
                                eos corrupti cupiditate.
                            </p>
                            <form>
